...
<div class="services-item list list-vertical item-elementor" itemscope itemtype="https://schema.org/TouristTrip" data-id="<?php echo esc_attr($post_id); ?>">
    <div class="item service-border st-border-radius">
        ...
        <div class="content-item">
            <div class="content-item-left">
                <?php if ($address) { ?>
                    <div class="sub-title d-flex align-items-center" itemprop="itinerary" itemscope itemtype="https://schema.org/ItemList">
                ...
                <div class="price-wrapper w-100 service-type d-sm-block d-md-block d-lg-block">
                    <span class="price-tour verticle">
                        <span class="price d-inline-block"><?php echo STTour::get_price_html(get_the_ID(),false, '',  'sale-top', false); ?></span>
                    </span>
                </div>
            </div>
