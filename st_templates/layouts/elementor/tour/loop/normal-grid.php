...
?>
<div class="item-tour <?php echo esc_attr($class); ?>" itemscope itemtype="https://schema.org/TouristTrip">
        ...
        <div class="content-item">
            ...
            <div class="section-footer">
                <div class="reviews d-flex align-items-center">
                    <?php
                        $post_id = get_the_ID();
                        $avg = STReview::get_avg_rate($post_id); // Always pass post ID!
                    ...
                    <span class="summary">
                        <?php
                        if($count_review > 0){
                            echo esc_html($avg) . " / 5 (" . esc_html($count_review) . ' ' . _n('Review', 'Reviews', $count_review, 'traveler') . ')';
                        } else {
                            esc_html_e('No Review', 'traveler');
                        }
                        ?>
                    </span>
                </div>
