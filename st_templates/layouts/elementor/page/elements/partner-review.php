<?php
// DEBUG: Display that the file is loading (on screen)
// echo 'DEBUG: partner-review.php is loading!<br>';

// DEBUG: Display arr_service before loop (on screen)
// 'UPDATED DEBUG: arr_service in partner-review.php: <pre>' . print_r // ($arr_service, true) . '</pre>';
						...
						<div class="booking-item-reviews list review-list">
							...
							if (!empty($comments)) {
								foreach ($comments as $comment) {
									echo st()->load_template('layouts/elementor/page/elements/review-list-author', '', array(
										'comment' => $comment,
