            ...
            <div class="st-hotel-content">
                <div class="hotel-target-book-mobile d-flex justify-content-between align-items-center">
                    ...
                    if ($activity_external == 'off' || empty($activity_external)) {
                        ...
                        ?>
                        <a href=""
                        class="btn btn-mpopup"><?php echo esc_html__('Book Now', 'traveler') ?></a>
                        <?php
                    }
                    ?>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 col-sm-9 col-md-9">
                                ...
                                <!--Tour Info-->
                                <?php echo st()->load_template('layouts/elementor/activity/single/item/infor', '', array(
...
// Manual counting per rating (5, 4, 3, 2, 1)
...
$labels = [
    5 => esc_html__('Excellent', 'traveler'),
    4 => esc_html__('Very Good', 'traveler'),
    3 => esc_html__('Average', 'traveler'),
    2 => esc_html__('Poor', 'traveler'),
    1 => esc_html__('Terrible', 'traveler'),
];
$colors = [
    5 => 'green',
    4 => 'darkgreen',
...
for ($i = 5; $i >= 1; $i--) {
    $percent = ($total > 0) ? TravelHelper::cal_rate($review_counts[$i], $total) : 0;
    ?>
    <div class="item">
        <div class="label"><?php echo $labels[$i]; ?></div>
        <div class="progress">
            <div class="percent <?php echo $colors[$i]; ?>"
                 style="width: <?php echo esc_attr($percent); ?>%;"></div>
        </div>
        <div class="number"><?php echo esc_html($review_counts[$i]); ?></div>
    </div>
    <?php
}
?>
                                ...
                                <div class="widgets">
                                    <div class="fixed-on-mobile" id="booking-request" data-screen="992px">
                                        ...
                                        <?php
                                            ...
                                            if($allow_partner == 'on'){
                                                ?>
                                            <?php echo st()->load_template('layouts/elementor/tour/single/item/owner-info'); ?>
                                            <?php }
