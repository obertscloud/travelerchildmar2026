                ...
                <div class="container">
                                        ...
                                        <?php
                                            ...
                                            if ( $comments ):
                                                foreach ( $comments as $key => $comment ):
                                                    echo st()->load_template( 'layouts/elementor/common/reviews/review', 'list', [ 'comment' => (object)$comment, 'post_type' => 'st_activity' ] );
                                                endforeach;
                                            endif;
                                        ?>
                                    </div>
                    ...
                    <?php
                        ...
                        foreach($terms_posts as $term_post){
                            $arr_id_term_post[] = !empty($term_post->term_id) ? $term_post->term_id : '';
                        }
                        $args = [
                            'posts_per_page' => 4,
